    ...
    <>
      <div className="flex flex-col sm:flex-row items-center min-h-screen bg-black text-white justify-center px-6 py-10">
        ...
        <div className="text-center mt-6 max-w-sm">
          ...
          {showloginPopup && <Login onClose={handelCloseloginPopup} onSignUp={handelOpenPopup} onForgotPassword={handleOpenForgotPasswordPopup} />}
          {showForgotPasswordPopup && <ForgotPassword onClose={handleCloseForgotPasswordPopup} onLogin={handelOpenloginPopup} />}
          ...
          <div className="text-center text-gray-400 mt-8 text-sm">
            ...
            <p className="mt-4">© 2025 JText Corp.</p>
          </div>
        </div>
      </div>
    </>
